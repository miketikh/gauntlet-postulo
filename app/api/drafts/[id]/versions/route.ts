/**
 * Draft Versions API - List all versions for a draft
...
import { getDraftVersions, getDraftWithProject } from '@/lib/services/draft.service';
import { createErrorResponse, NotFoundError } from '@/lib/errors';

/**
 * GET /api/drafts/:id/versions
 * Returns list of all versions (limited to last 50) for a draft
