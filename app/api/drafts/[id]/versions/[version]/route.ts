/**
 * Draft Version Details API - Get specific version content
...
import { getDraftVersion, getDraftWithProject } from '@/lib/services/draft.service';
...
export async function GET(
  ...
  try {
    ...
    const snapshot = await getDraftVersion(draftId, version);
